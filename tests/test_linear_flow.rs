...
fn make_linear_graph() -> BasicBlockGraph {
    BasicBlockGraph {
        ...
        nodes: vec![
            ...
            BbNode::Compute(Opcode::Add, smallvec::smallvec![bb_val(0), bb_val(1)]), // 2: y = x + 1
            BbNode::Const(2, RawType::Scalar(32)),                               // 3: 2
            BbNode::Compute(Opcode::Mul, smallvec::smallvec![bb_val(2), bb_val(3)]), // 4: ret = y * 2
        ],
        bbs: vec![
            BasicBlock {
            ...
            BasicBlock {
                ...
                terminator: BbTerm::Return {
                    effect_args: vec![],
                    common_args: vec![bb_val(4)], // ret = node 4
                },
            },
        ],
    }
